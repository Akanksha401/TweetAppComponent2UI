...
export class TweetappService {
  ...
  {​​​​​​​​    
   ...
   public ForgotPassword(emailid:string,contactnumber:string,password:string):Observable<String>
  {​​​​​​​​    
     const headers = new HttpHeaders().set('Content-Type', 'text/html; charset=utf-8');
   return this.http.put<String>(this.url+'forgot/'+escape(emailid)+','+escape(contactnumber)+','+escape(password),{​​​​​​​​ headers, responseType: 'text' }​​​​​​​​)
  }​​​​​​​​
