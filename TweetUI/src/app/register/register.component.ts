...
export class RegisterComponent implements OnInit {
  ...
  constructor(private frombuilder:FormBuilder,private service:TweetappService,private route:Router, private FireStorageClient : AngularFireStorage) { }
  ...
  onSubmitUser(){
    ...
    fileEvent(event :any){
      ...
      const fileRef = this.FireStorageClient.ref(this.imageFile.name);
      this.FireStorageClient.upload(this.imageFile.name, this.imageFile).snapshotChanges().pipe(
        finalize(() => {
